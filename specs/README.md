# Technical Specifications & Development Documentation
# apprun BaaS Platform

This directory contains **technical specifications and development documentation** following the **BMad Method** workflow.

> **Note**: User-facing documentation is in [`/docs`](../docs/) directory.
...
> **User Documentation**: See [`/docs/product`](../docs/product/) for installation guides and user manuals.
