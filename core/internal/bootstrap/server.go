// Package bootstrap provides application startup orchestration logic.
// This is internal business logic and should not be treated as a reusable library.
package bootstrap
...
// StartServer starts the AppRun API server with full initialization sequence.
