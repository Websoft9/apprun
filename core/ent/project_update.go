...
func (_u *ProjectUpdate) SetStatus(v int8) *ProjectUpdate {
...
func (_u *ProjectUpdate) SetNillableStatus(v *int8) *ProjectUpdate {
	if v != nil {
		_u.SetStatus(*v)
	}
	return _u
...
func (_u *ProjectUpdate) AddStatus(v int8) *ProjectUpdate {
...
// SetStatus sets the "status" field.
func (_u *ProjectUpdateOne) SetStatus(v int8) *ProjectUpdateOne {
	_u.mutation.ResetStatus()
	_u.mutation.SetStatus(v)
	return _u
}
...
// SetNillableStatus sets the "status" field if the given value is not nil.
func (_u *ProjectUpdateOne) SetNillableStatus(v *int8) *ProjectUpdateOne {
	if v != nil {
		_u.SetStatus(*v)
	}
	return _u
...
// AddStatus adds value to the "status" field.
func (_u *ProjectUpdateOne) AddStatus(v int8) *ProjectUpdateOne {
	_u.mutation.AddStatus(v)
	return _u
}
