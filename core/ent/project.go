...
type Project struct {
	...
	// External UUID for API usage in REST paths
	UUID string `json:"uuid,omitempty"`
	// Name holds the value of the "name" field.
	Name string `json:"name,omitempty"`
	// Description holds the value of the "description" field.
	Description string `json:"description,omitempty"`
	// Project owner user_id, foreign key to users.id
...
func (*Project) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case project.FieldID, project.FieldOwnerID, project.FieldStatus:
			values[i] = new(sql.NullInt64)
		case project.FieldUUID, project.FieldName, project.FieldDescription:
