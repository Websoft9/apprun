...
func setupStorageHandler(t *testing.T) (*StorageHandler, *storage.MockStorage) {
	cfg := &metricstore.Config{
		Storage: metricstore.StorageConfig{
			Backend: "mock",
...
func TestStorageHandler_Query(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			req := httptest.NewRequest(http.MethodGet, "/api/metrics/storage/query"+tt.queryParams, nil)
			w := httptest.NewRecorder()
...
func TestStorageHandler_QueryWithTimeRange(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/api/metrics/storage/query?name=time_test&start="+start+"&end="+end, nil)
	w := httptest.NewRecorder()
...
func TestStorageHandler_Health(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req := httptest.NewRequest(http.MethodGet, "/api/metrics/storage/health", nil)
			w := httptest.NewRecorder()
