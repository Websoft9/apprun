...
### ✅ Completed (14/17)
- **story-01**: Docker 开发部署环境
- **story-02**: 统一响应工具包
- **story-03**: 业务错误包装框架
- **story-05**: CI/CD 流水线与 Linter
- **story-05a**: 数据库增量迁移
- **story-05c**: Makefile 标准与命令分组
- **story-12**: 日志防腐层
- **story-14**: HTTP Server Package
- **story-15**: Environment Variable Utility
- **story-16**: Database Anti-Corruption Layer
- **story-17**: Go 1.25.5 升级

### 📝 Pending (3/17)
- **story-05b**: 服务端 CLI 框架（Cobra）
- **story-06**: 测试框架与工具集
- **story-07**: 重构现有 Handlers
