# Docker Base Image Maintenance Guide
...
- Cold build: 8-10 min → 5-8 min (base) + 1-2 min (app)  
- Warm build: 5-8 min → 2-3 seconds (80-90% faster)  
- CI/CD: 6-10 min → 2-3 min (60-70% reduction)
